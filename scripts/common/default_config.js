// Panda 主題默認配置 (forked from hexo-theme-butterfly, Apache-2.0)
// Default configuration for Panda theme
...
module.exports = {
  ...
  gradient: {
    enable: true,
    header_light: 'linear-gradient(135deg, #4facfe 0%, #6ec6ff 25%, #a18cd1 55%, #fbc2eb 75%, #ffd2a8 100%)',
    header_dark: 'linear-gradient(135deg, #020024 0%, #090979 25%, #1a2440 50%, #5b425d 75%, #9d4edd 100%)',
    header_mask_light: 'linear-gradient(180deg, rgba(26, 73, 118, 0.08) 0%, rgba(60, 66, 122, 0.16) 100%)',
